...
urlpatterns = [
    ...
    path(
        ...
        views.resend_reset_password_otp,
    ...
    path(
        "profile/upload-image/", views.update_profile_image, name="update_profile_image"
    ),
    ...
    path(
        "add-address-checkout/", views.add_address_checkout, name="add_address_checkout"
    ),
    ...
    path(
        "add-to-cart-from/<int:product_id>/",
    ...
    path(
        "order-payment-success/<str:order_id>/",
    ...
    path(
        ...
        views.request_item_return,
        name="request_item_return",
    ),
]
