...
from  accounts.models import Product,ProductImage,ProductVariant
...
class Order(models.Model):
    ...
    return_status = models.CharField(max_length=20, choices=RETURN_STATUS_CHOICES, default='not_requested', blank=True)
...
class OrderItem(models.Model):
    ...
    status = models.CharField(max_length=20, choices=[('Pending', 'Pending'), ('Cancelled', 'Cancelled'),('Delivered', 'Delivered'),   
